            ...
            <div>
                ...
                <div>
                    <div className="flex justify-around md:flex sm:grid mt-10 mx-20 ">
                        <div className="relative bg-white w-72 md:w-72 sm:w-96 md:ml-0 sm:-ml-14 h-52 rounded-lg text-center shadow-lg flex flex-col items-center p-4">
                        ...
                        <Link to='/roadmap'>
                        <div className="relative bg-white w-72 md:w-72 sm:w-96 md:ml-0 sm:-ml-14 h-52 rounded-lg text-center shadow-lg flex flex-col items-center p-4 md:mt-0 sm:mt-10"> 
                            <div className="bg-blue-700 w-20 h-20 rounded-full flex justify-center items-center absolute -top-8">

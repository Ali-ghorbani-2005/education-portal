        ...
        <>
            ...
            <div className="flex items-center mt-4 ml-4">
                <div className="border-r border-white pr-4"> 
                    <Link to='/signUp'>
                    <button className="bg-blue-600 text-white text-lg font-semibold py-2 px-4 rounded hover:bg-blue-700 transition duration-200">ثبت نام</button> 
                    </Link>
                </div>
                <div className="flex items-center ml-4"> 
                    <Link to='/login'>
                    <button className="bg-green-600 text-white text-lg font-semibold py-2 px-4 rounded hover:bg-green-700 transition duration-200">ورود</button> 
                    </Link>
